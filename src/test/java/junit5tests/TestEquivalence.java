...
import calculator.expression.operation.Equivalence;
...
public class TestEquivalence {
    ...
    public void testConstructor1() {
        ...
        assertThrows(IllegalConstruction.class, () -> op = new Equivalence(null));
    }

    @SuppressWarnings("AssertBetweenInconvertibleTypes")
    @Test
    public void testConstructor2() {
        // A Times expression should not be the same as a Equivalence expression
        try {
    ...
    public void testEquals() {
        ...
        try {
            Equivalence d = new Equivalence(p, Notation.INFIX);
            assertEquals(op, d);
        } catch (IllegalConstruction e) {
            fail();
        }
    ...
    public void testHashCode() {
        ...
        ArrayList<Expression> p = new ArrayList<>(Arrays.asList(new MyNumber(value1), new MyNumber(value2)));
        try {
            Equivalence e = new Equivalence(p, Notation.INFIX);
    ...
    public void testNullParamList() {
        params = null;
        assertThrows(IllegalConstruction.class, () -> op = new Equivalence(params));
    }
